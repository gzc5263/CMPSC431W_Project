...
function from_elkjs(graph, elkGraph) {
  ...
  for (const edge of elkGraph.edges) {
    ...
    if (!bps) continue; // elkjs gives us a bunch of points to create straight edges.
    ...
    for (const bp of bps) add_point(bp, false); // use the end point to finish the last bend point without adding the end point itself.
