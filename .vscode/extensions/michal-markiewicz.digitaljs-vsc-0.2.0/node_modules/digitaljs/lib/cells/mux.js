...
exports.MuxSparseView = exports.MuxSparse = exports.Mux1HotView = exports.Mux1Hot = exports.MuxView = exports.Mux = exports.GenMuxView = exports.GenMux = void 0;
...
const mux_size_offset = 30; // Multiplexers

const GenMux = _base.Gate.define('GenMux', {
  /* default properties */
  bits: {
    in: 1,
    sel: 1
...
exports.GenMux = GenMux;

const GenMuxView = _base.GateView.extend({
  initialize() {
...
exports.GenMuxView = GenMuxView;
const Mux = GenMux.define('Mux', {}, {
  muxInputs: n => Array(1 << n),
  muxInput: i => i.isFullyDefined ? i.toBigInt().toString() : undefined
});
exports.Mux = Mux;
const MuxView = GenMuxView; // Multiplexer with one-hot selection

exports.MuxView = MuxView;
const Mux1Hot = GenMux.define('Mux1Hot', {
  attrs: {
    info: {
      refX: .5,
      refY: .5,
...
exports.Mux1Hot = Mux1Hot;
const Mux1HotView = GenMuxView;
exports.Mux1HotView = Mux1HotView;
const MuxSparse = GenMux.define('MuxSparse', {
  /* default properties */
  inputs: undefined,
  default_input: false
}, {
...
exports.MuxSparse = MuxSparse;
const MuxSparseView = GenMuxView;
exports.MuxSparseView = MuxSparseView;