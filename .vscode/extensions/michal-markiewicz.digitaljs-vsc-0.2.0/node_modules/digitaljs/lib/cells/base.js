...
exports.BoxView = exports.Box = exports.WireView = exports.Wire = exports.GateView = exports.Gate = exports.portGroupAttrs = void 0;
...
exports.portGroupAttrs = portGroupAttrs;
const Gate = joint.shapes.basic.Generic.define('Gate', {
  /* default properties */
  propagation: 1,
  label: '',
  size: {
  ...
  _setPortsBits(portsBits) {
    ...
    this._resetPortsSignals(portsReset); //trigger port changes on model and view
...
exports.Gate = Gate;
const GateView = joint.dia.ElementView.extend({
  attrs: {
    signal: {
      high: {
        port: {
...
exports.GateView = GateView;
const Wire = joint.shapes.standard.Link.define('Wire', {
  attrs: {
    line: {
      class: 'connection',
      targetMarker: null
  ...
  _changeSource(src) {
    ...
    if (source && 'port' in src) {
      ...
      this._checkConnection(); //set signal after checking connection to avoid false signal propagation
...
exports.Wire = Wire;
const WireView = joint.dia.LinkView.extend({
...
exports.WireView = WireView;
const Box = Gate.define('Box', {
  attrs: {
    body: {
      refWidth: 1,
      refHeight: 1
