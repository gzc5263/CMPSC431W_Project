...
exports.ClockView = exports.Clock = exports.ConstantView = exports.Constant = exports.NumDisplayView = exports.NumDisplay = exports.LampView = exports.Lamp = exports.OutputView = exports.Output = exports.NumEntryView = exports.NumEntry = exports.ButtonView = exports.Button = exports.InputView = exports.Input = exports.IOView = exports.IO = exports.NumBaseView = exports.NumBase = void 0;
...
// Things with numbers
const NumBase = _base.Box.define('NumBase', {
  /* default properties */
  numbase: 'hex',
  bits: 1
}, {
...
exports.NumBase = NumBase;

const NumBaseView = _base.BoxView.extend({
...
exports.NumBaseView = NumBaseView;
const IO = NumBase.define('IO', {
  /* default properties */
  bits: 1,
  net: '',
...
exports.IO = IO;
const IOView = NumBaseView.extend({
  _calculateBoxWidth() {
...
exports.IOView = IOView;
const Input = IO.define('Input', {
  attrs: {
    btnface: {
      stroke: 'black',
      strokeWidth: 2,
...
const ButtonView = InputView;
exports.ButtonView = ButtonView;
const NumEntry = Input;
exports.NumEntry = NumEntry;
const NumEntryView = InputView; // Output model

exports.NumEntryView = NumEntryView;
const Output = IO.define('Output', {
  attrs: {
    led: {
      refX: .5,
      refY: .5,
...
const OutputView = IOView.extend({
  attrs: _lodash.default.merge({
    lamp: {
      high: {
        led: {
...
const Lamp = Output;
exports.Lamp = Lamp;
const LampView = OutputView;
exports.LampView = LampView;
const NumDisplay = Output;
exports.NumDisplay = NumDisplay;
const NumDisplayView = OutputView; // Constant

exports.NumDisplayView = NumDisplayView;
const Constant = NumBase.define('Constant', {
  /* default properties */
  constant: '0',
  propagation: 0,
  attrs: {
...
const ConstantView = NumBaseView.extend({
...
exports.ConstantView = ConstantView;

const Clock = _base.Box.define('Clock', {
  /* default properties */
  propagation: 100,
  ports: {
    items: [{
...
const ClockView = _base.BoxView.extend({
  presentationAttributes: _base.BoxView.addPresentationAttributes({
    propagation: 'SIGNAL'
  }),
  events: {
