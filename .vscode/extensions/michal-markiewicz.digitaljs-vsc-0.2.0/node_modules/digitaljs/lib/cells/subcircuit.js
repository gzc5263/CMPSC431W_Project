...
const subcircuit_size_offset = 10; // Subcircuit model -- embeds a circuit graph in an element

const Subcircuit = _base.Box.define('Subcircuit', {
  /* default properties */
  propagation: 0,
  warning: false,
  attrs: {
...
exports.Subcircuit = Subcircuit;

const SubcircuitView = _base.BoxView.extend({
...
exports.SubcircuitView = SubcircuitView;