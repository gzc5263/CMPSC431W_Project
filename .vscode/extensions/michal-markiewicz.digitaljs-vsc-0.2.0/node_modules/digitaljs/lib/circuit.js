...
exports.HeadlessCircuit = void 0;
...
class HeadlessCircuit {
  ...
  _makeGraph(data, subcircuits, opt) {
    ...
    const changeWarnings = x => {
      graph._warnings += x;
      console.assert(graph._warnings >= 0); //todo: better handling for stopping simulation

      if (graph._warnings > 0 && this.running) this.stop(); // bubble warning up in case of subcircuit
